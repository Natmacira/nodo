...
<body>
	...
	<main>
		...
		<section id="nuestra-mision">
			...
			<div class="promedios">
				<h3 class="numeros-estadisticas green">2.122.425</h3>
				<p>KG fueron entregados desde 2021</p>
				<h3 class="numeros-estadisticas pink">5.942.790</h3>
		...
		<section id="impacto-ambiental">
			<article>
				...
				<p>2.674.255 KG CO2 eq emisiones de gases de efecto invernadero fueron prevenidas.
					A su vez, 6.683 millones de litros de agua no fueron desperdiciados.</p>
			</article>
			<article id="estadisticas">

				<h3 class="numeros-estadisticas green">2.674.255</h3>
				<p>KG CO2 eq emisiones prevenidas</p>

				<h3 class="numeros-estadisticas pink">6.683</h3>
