...
<body>
	<header>
		...
		<img src="img/picture-worker.jpg" loading="lazy" alt="Una persona de espaldas, observando un campo con vegetales" id="picture-worker">
	...
	<main>
		...
		<section id="el-problema">
			<img src="img/picture-onions.jpg" loading="lazy" alt="Dos manos sosteniendo dos vegetales">
		...
		<section id="nuestra-mision">
			...
			<img src="img/picture-truck.jpg" loading="lazy" alt="Una mano sosteniendo una papa con forma de corazón">
			<div class="promedios">
				<h3 class="numeros-estadisticas green">7.254.279</h3>
				<p>KG fueron entregados desde 2021</p>
				<h3 class="numeros-estadisticas pink">21.762.837</h3>
		...
		<section id="objetivos">
			<img class="marquee-picture" src="img/picture-box-worker.jpg" loading="lazy" alt="Varias bolsas de arpillera muy grandes, llenas de zanahorias">
		...
		<section id="impacto-ambiental">
			<article>
				...
				<p>3.191.882  Toneladas de CO2 eq. emisiones de gases de efecto invernadero fueron prevenidas.
					A su vez 2.901.711 m3 de agua no fueron desperdiciadas.</p>
			</article>
			<article id="estadisticas">

				<h3 class="numeros-estadisticas green">3.191.882</h3>
				<p>TN CO2 eq. emisiones prevenidas</p>

				<h3 class="numeros-estadisticas pink">2.901.711</h3>
		...
		<section id="alcances">
			<img src="img/MAPA.png" loading="lazy" alt="Un mapa de la republica Argentina con marcaciones de las diferentes zonas donde funciona la ONG" class="marquee-picture mapa">
			<article>
				<h2>____ Alcances</h2>
				...
				<ul class="geographical-reach">
					...
					<li class="location">― villa gesell</li>
		...
		<section id="aliados">
			...
			<article>
				...
				<img class="external-logo basf" src="img/logo-BASF.jpg" loading="lazy" alt="Logo BASF. Leyenda: We create chemistry">
				...
				<img class="external-logo albor" src="img/Albor_Logo.png" loading="lazy" alt="Logo Albor">
				<img class="external-logo naika" src="img/logo-naika.png" loading="lazy" alt="Logo Naika">
				<img class="external-logo sumi" src="img/logo-sumi.png" loading="lazy" alt="Logo Sumi">
			</article>
		</section>
