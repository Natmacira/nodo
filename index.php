...
<body>
	...
	<main>
		...
		<section id="nuestra-mision">
			...
			<div class="promedios">
				<h3 class="numeros-estadisticas green">2.161.832</h3>
				<p>KG fueron entregados desde 2021</p>
				<h3 class="numeros-estadisticas pink">6.051.990</h3>
		...
		<section id="impacto-ambiental">
			<article>
				...
				<p>2.723.395 KG CO2 eq emisiones de gases de efecto invernadero fueron prevenidas.
					A su vez, 6.806 millones de litros de agua no fueron desperdiciados.</p>
			</article>
			<article id="estadisticas">

				<h3 class="numeros-estadisticas green">2.723.395</h3>
				<p>KG CO2 eq emisiones prevenidas</p>

				<h3 class="numeros-estadisticas pink">6.806</h3>
