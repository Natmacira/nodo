...
<body>
	<header>
		...
		<img src="img/picture-worker.jpg" loading="lazy" alt="Un señor trabajando con cajas de verduras." id="picture-worker">
	...
	<main>
		...
		<section id="quienes-somos">
			...
			<h3>NODO es un proyecto colaborativo, impulsado por los Bancos de Alimentos del corredor Mar y
				Sierras.</h3>
			<article>
				<img class="external-logo one" src="img/logo-banco-de-alimentos-mdp.png" loading="lazy" alt="Logo con dos manos verdes del Banco de Alimentos Mar del Plata">
				<img class="external-logo two" src="img/logo-banco-de-alimentos-tandil.png" loading="lazy" alt="Logo con una caja de cartón abierta del Banco de Alimentos Tandil">
				<img class="external-logo three" src="img/logo-BDA-Balcarce.png" loading="lazy" alt="Logo del BDA Balcarce romado por dos circulos y una flecha que conforman una forma de U">
			</article>
		</section>
		<section id="el-problema">
			<img src="img/picture-onions.jpg" loading="lazy" alt="Una imagen de unas manos vaciando una bolsa de arpillera llena de cebollas en una caja que contiene mas cebollas.">
		...
		<section id="nuestra-mision">
			...
			<div class="promedios">
				<h3 class="numeros-estadisticas green">3.487.990</h3>
				<p>KG fueron entregados desde 2021</p>
				<h3 class="numeros-estadisticas pink">10.463.970</h3>
		...
		<section id="objetivos">
			<img class="marquee-picture" src="img/picture-box-worker.jpg" loading="lazy" alt="En la imagen se ve una persona trasladado una caja verde, típica caja donde van verduras y frutas. Se ven unas manos que reciben la caja. La persona tiene un barbijo negro puesto por debajo de la nariz.">
			...
			<div>
				<img src="img/box-hambre-cero.png" class="boxes-information" loading="lazy" alt="Un cuadrado naranja que contiene en blanco un número dos, un plato de comida y la frase HAMBRE CERO">
				<img src="img/box-reduccion.png" class="boxes-information" loading="lazy" alt="Un cuadrado fuccia que contiene en blanco un número diez, unas flechas y la frase REDUCCION DE LAS DESIGUALDADES">
				<img src="img/box-produccion.png" class="boxes-information" loading="lazy" alt="Un cuadrado naranja que contiene en blanco el número doce, el símbolo del infinito y la frase PRODUCCION Y CONSUMOS RESPONSABLES">
				<img src="img/box-accion.png" class="boxes-information" loading="lazy" alt="Un cuadrado verde que contiene en blanco el número 12, el dibujo de un ojo donde la pupila es un planeta tierra, y la frase ACCIÓN POR EL CLIMA">
				<img src="img/rojo.png" class="boxes-information" loading="lazy" alt="Un cuadrado rojo que contiene en blanco el número 4, texto: educación de calidad">
				<img src="img/azul.png" class="boxes-information" loading="lazy" alt="Un cuadrado azul que contiene en blanco el número 17, texto: alianzas para lograr los objetivos">
			</div>
		</section>
		<section id="impacto-ambiental">
			<article>
				...
				<p>1.541  Toneladas de CO2 eq. emisiones de gases de efecto invernadero fueron preveenidas.
					A su vez 10.987.168 m3 de agua no fueron desperdiciadas.</p>
			</article>
			<article id="estadisticas">

				<h3 class="numeros-estadisticas green">1.541</h3>
				<p>TN CO2 eq. emisiones prevenidas</p>

				<h3 class="numeros-estadisticas pink">10.987.168</h3>
		...
		<section id="alcances">
			<img src="img/MAPA.jpg" loading="lazy" alt="Un mapa de la republica Argentina con marcaciones en azul de las diferentes zonas donde funciona la ONG" class="marquee-picture mapa">
			<article>
				<h2>____ Alcances</h2>
		...
		<section id="aliados">
			...
			<article>
				<img class="external-logo redBDA" src="img/logo-redBDA.png" loading="lazy" alt="Logo red BDA">
				<img class="external-logo food-banking" src="img/logo-global-food-banking.png" loading="lazy" alt="Logo Global Food Banking ">
				<img class="external-logo inta" src="img/logo-inta.png" loading="lazy" alt="Logo inta">
				<img class="external-logo uni-mdp" src="img/logo-universidad-nac-mdp.png" loading="lazy" alt="Logo Universidad Nacional de Mar del Plata">
				<img class="external-logo w-w" src="img/logo-w.png" loading="lazy" alt="Logo volkswagen">
				<img class="external-logo alimentaris" src="img/logo-fundacion-alimentaris.png" loading="lazy" alt="Logo Fundación Alimentaris">
				<img class="external-logo pepsico" src="img/logo-pepsico.png" loading="lazy" alt="Logo Pepsico">
				<img class="external-logo corteva" src="img/logo-corteva.png" loading="lazy" alt="Logo Corteva">
				<img class="external-logo terramar" src="img/logo-terramar.png" loading="lazy" alt="Logo Terramar">
				<img class="external-logo basf" src="img/logo-BASF.png" loading="lazy" alt="Logo BASF. Leyenda: We create chemistry">
				<img class="external-logo ifco" src="img/logo-IFCO.png" loading="lazy" alt="Logo IFCO">
				<img class="external-logo sanAlberto" src="img/logo-SAN ALBERTO.png" loading="lazy" alt="Logo San Alberto">
				<img class="external-logo lima" src="img/logo-lima.jpg" loading="lazy" alt="Logo Lima Estudio">
				<img class="external-logo lima" src="img/Albor_Logo.png" loading="lazy" alt="Logo Albor">
			</article>
		</section>
		<section id="imagenes-galeria-footer">
			<img src="img/background-footer-mobile.jpg" loading="lazy" alt="" class="gallery mobile">
			<img src="img/pictures-collage.jpg" loading="lazy" alt="" class="gallery desktop">
		</section>
	</main>
	<footer>
		...
		<a href="#"><img class="logo-img" src="img/logo-nodo.png" loading="lazy" alt="Logo de Nodo"></a>
		<ul>
			<li><a class="instagram-link" href="https://instagram.com/nodo.rescate?utm_medium=copy_link" target="_blank">
					<img src="img/logo-instagram.png" loading="lazy" alt="Logo con link de acceso a instagram">
				</a></li>
			<li><a class="linkedin-link" href="https://www.linkedin.com/company/nodo-rescate-de-excedentes-27600b226/?lipi=urn%3Ali%3Apage%3Acompanies_company_index%3B2de6c395-1d8d-42d9-987b-ed8c95da3cc9" target="_blank">
					<img src="img/logo-linkedin.png" loading="lazy" alt="Logo con link de acceso a Linkedin">
				</a></li>
			<li><a class="linkedin-link" href="https://www.youtube.com/channel/UCcrMCzUJa0qam1fXN9htyEw" target="_blank">
					<img src="img/youtube-link.png" loading="lazy" alt="Logo con link de acceso a youtube">
				</a></li>
		</ul>
	</footer>
