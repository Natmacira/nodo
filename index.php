...
<body>
	...
	<main>
		...
		<section id="nuestra-mision">
			...
			<div class="promedios">
				<h3 class="numeros-estadisticas green">2.581.333</h3>
				<p>KG fueron entregados desde 2021</p>
				<h3 class="numeros-estadisticas pink">7.743.999</h3>
		...
		<section id="impacto-ambiental">
			<article>
				...
				<p>11.261 KG CO2 eq emisiones de gases de efecto invernadero fueron prevenidas.
					A su vez, 8.023 millones de litros de agua no fueron desperdiciados.</p>
			</article>
			<article id="estadisticas">

				<h3 class="numeros-estadisticas green">11.261</h3>
				<p>KG CO2 eq emisiones prevenidas</p>

				<h3 class="numeros-estadisticas pink">8.023</h3>
